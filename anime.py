...
for event in longpoll.listen():
	if event.type == VkEventType.MESSAGE_NEW:
		...
		if msg == 'атака титанов':
			...
			vk_session.method('messages.send', {'user_id' : id, 'message' : 'Доступно:' + '\n📜Манга' + '\n📷Фото', 'keyboard': ataka, 'random_id' : random.randint(-1234567, +1234567)})

		if msg == 'манга':
			if users[user_id].stats == 2:
				sender(id, 'Выберите главу манги (доступно: 127-130)')
			...
			if users[user_id].stats == 2:
				...
				if users[user_id].number == 129:
					...
					if users[user_id].manga == 1:
						...
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед', 'keyboard' : welcome, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 2:
						photo(id, 'photo-202584478_457239175') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 3:
						photo(id, 'photo-202584478_457239176') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 4:
						photo(id, 'photo-202584478_457239177') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 5:
						photo(id, 'photo-202584478_457239178') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 6:
						photo(id, 'photo-202584478_457239179') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 7:
						photo(id, 'photo-202584478_457239180')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 8:
						photo(id, 'photo-202584478_457239181') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 9:
						photo(id, 'photo-202584478_457239182') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 10:
						photo(id, 'photo-202584478_457239183') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 11:
						photo(id, 'photo-202584478_457239184') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 12:
						photo(id, 'photo-202584478_457239185') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 13:
						photo(id, 'photo-202584478_457239186') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 14:
						photo(id, 'photo-202584478_457239187') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 15:
						photo(id, 'photo-202584478_457239188') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 16:
						photo(id, 'photo-202584478_457239189') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 17:
						photo(id, 'photo-202584478_457239190')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 18:
						photo(id, 'photo-202584478_457239191') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 19:
						photo(id, 'photo-202584478_457239192') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 20:
						photo(id, 'photo-202584478_457239193') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 21:
						photo(id, 'photo-202584478_457239194') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 22:
						photo(id, 'photo-202584478_457239195') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 23:
						photo(id, 'photo-202584478_457239196') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 24:
						photo(id, 'photo-202584478_457239197')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 25:
						photo(id, 'photo-202584478_457239198') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 26:
						photo(id, 'photo-202584478_457239199') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 27:
						photo(id, 'photo-202584478_457239200') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 28:
						photo(id, 'photo-202584478_457239201')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 29:
						photo(id, 'photo-202584478_457239202') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 30:
						photo(id, 'photo-202584478_457239203') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 31:
						photo(id, 'photo-202584478_457239204') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 32:
						photo(id, 'photo-202584478_457239205') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 33:
						photo(id, 'photo-202584478_457239206') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 34:
						photo(id, 'photo-202584478_457239207') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 35:
						photo(id, 'photo-202584478_457239208') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 36:
						photo(id, 'photo-202584478_457239209') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 37:
						photo(id, 'photo-202584478_457239210')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 38:
						photo(id, 'photo-202584478_457239211') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 39:
						photo(id, 'photo-202584478_457239212') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 40:
						photo(id, 'photo-202584478_457239213') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 41:
						photo(id, 'photo-202584478_457239214') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 42:
						photo(id, 'photo-202584478_457239215') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 43:
						photo(id, 'photo-202584478_457239216') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 44:
						photo(id, 'photo-202584478_457239217')
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Конец "129" главы', 'keyboard' : back, 'random_id' : random.randint(-1234567, +1234567)})

				if users[user_id].number == 130:
					users[user_id].go(event)
					if users[user_id].manga == 1:
						photo(id, 'photo-202584478_457239254') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед', 'keyboard' : welcome, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 2:
						photo(id, 'photo-202584478_457239255') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 3:
						photo(id, 'photo-202584478_457239256') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 4:
						photo(id, 'photo-202584478_457239257') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 5:
						photo(id, 'photo-202584478_457239258') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 6:
						photo(id, 'photo-202584478_457239259') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 7:
						photo(id, 'photo-202584478_457239260')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 8:
						photo(id, 'photo-202584478_457239261') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 9:
						photo(id, 'photo-202584478_457239262') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 10:
						photo(id, 'photo-202584478_457239263') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 11:
						photo(id, 'photo-202584478_457239264') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 12:
						photo(id, 'photo-202584478_457239265') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 13:
						photo(id, 'photo-202584478_457239266') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 14:
						photo(id, 'photo-202584478_457239267') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 15:
						photo(id, 'photo-202584478_457239268') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 16:
						photo(id, 'photo-202584478_457239269') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 17:
						photo(id, 'photo-202584478_457239270')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 18:
						photo(id, 'photo-202584478_457239271') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 19:
						photo(id, 'photo-202584478_457239272') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 20:
						photo(id, 'photo-202584478_457239273') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 21:
						photo(id, 'photo-202584478_457239274') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 22:
						photo(id, 'photo-202584478_457239275') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 23:
						photo(id, 'photo-202584478_457239276') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 24:
						photo(id, 'photo-202584478_457239277')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 25:
						photo(id, 'photo-202584478_457239278') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 26:
						photo(id, 'photo-202584478_457239279') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 27:
						photo(id, 'photo-202584478_457239280') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 28:
						photo(id, 'photo-202584478_457239281')  
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 29:
						photo(id, 'photo-202584478_457239282') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 30:
						photo(id, 'photo-202584478_457239283') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 31:
						photo(id, 'photo-202584478_457239284') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 32:
						photo(id, 'photo-202584478_457239285') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 33:
						photo(id, 'photo-202584478_457239286') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 34:
						photo(id, 'photo-202584478_457239287') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 35:
						photo(id, 'photo-202584478_457239288') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть вперед' + '\nИспользуйте "Перелистнуть назад", чтобы перелистнуть назад', 'keyboard' : forma, 'random_id' : random.randint(-1234567, +1234567)})
					if users[user_id].manga == 36:
						photo(id, 'photo-202584478_457239289') 
						vk_session.method('messages.send', {'user_id' : id, 'message' : 'Конец "130" главы', 'keyboard' : back, 'random_id' : random.randint(-1234567, +1234567)})
		...
		if msg == '129':
			if users[user_id].stats == 2:
				users[user_id].number = 129
				photo(id, 'photo-202584478_457239073')
				vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть', 'keyboard' : welcome, 'random_id' : random.randint(-1234567, +1234567)})
		
		if msg == '130':
			if users[user_id].stats == 2:
				users[user_id].number = 130
				photo(id, 'photo-202584478_457239073')
				vk_session.method('messages.send', {'user_id' : id, 'message' : 'Используйте "Перелистнуть вперед", чтобы перелистнуть', 'keyboard' : welcome, 'random_id' : random.randint(-1234567, +1234567)})

		if msg == 'перелистнуть назад':
			if users[user_id].stats == 2:
				if users[user_id].number == 127:
		...
		if msg == 'фото':
			...
			if users[user_id].stats == 2:
				users[user_id].photo = random.randint(1, 36)
				if users[user_id].photo == 1:
					photo(id, 'photo-202584478_457239218')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 2:
					photo(id, 'photo-202584478_457239219')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 3:
					photo(id, 'photo-202584478_457239220')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 4:
					photo(id, 'photo-202584478_457239221')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 5:
					photo(id, 'photo-202584478_457239222')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 6:
					photo(id, 'photo-202584478_457239223')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 7:
					photo(id, 'photo-202584478_457239224')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 8:
					photo(id, 'photo-202584478_457239225')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 9:
					photo(id, 'photo-202584478_457239226')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 10:
					photo(id, 'photo-202584478_457239227')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 11:
					photo(id, 'photo-202584478_457239228')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 12:
					photo(id, 'photo-202584478_457239229')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 13:
					photo(id, 'photo-202584478_457239230')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 14:
					photo(id, 'photo-202584478_457239231')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 15:
					photo(id, 'photo-202584478_457239232')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 16:
					photo(id, 'photo-202584478_457239233')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 17:
					photo(id, 'photo-202584478_457239234')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 18:
					photo(id, 'photo-202584478_457239235')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 19:
					photo(id, 'photo-202584478_457239236')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 20:
					photo(id, 'photo-202584478_457239237')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 21:
					photo(id, 'photo-202584478_457239238')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 22:
					photo(id, 'photo-202584478_457239239')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 23:
					photo(id, 'photo-202584478_457239240')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 24:
					photo(id, 'photo-202584478_457239241')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 25:
					photo(id, 'photo-202584478_457239242')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 26:
					photo(id, 'photo-202584478_457239243')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 27:
					photo(id, 'photo-202584478_457239244')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 28:
					photo(id, 'photo-202584478_457239245')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 29:
					photo(id, 'photo-202584478_457239246')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 30:
					photo(id, 'photo-202584478_457239247')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 31:
					photo(id, 'photo-202584478_457239248')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 32:
					photo(id, 'photo-202584478_457239249')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 33:
					photo(id, 'photo-202584478_457239250')
					vk_session.method('messages.send', {'user_id' : id, 'message' : 'Напишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 34:
					photo(id, 'photo-202584478_457239251')
					vk_session.method('messages.send', {'user_id' : id, 'message' : '👤Арт был нарисован Эвелиной Сюткиной' + '\nНапишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 35:
					photo(id, 'photo-202584478_457239252')
					vk_session.method('messages.send', {'user_id' : id, 'message' : '👤Арт был нарисован Эвелиной Сюткиной' + '\nНапишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})
				if users[user_id].photo == 36:
					photo(id, 'photo-202584478_457239253')
					vk_session.method('messages.send', {'user_id' : id, 'message' : '👤Арт был нарисован Эвелиной Сюткиной' + '\nНапишите "фото", чтобы посмотреть еще фотографий', 'keyboard' : photo_key, 'random_id' : random.randint(-1242412, +1242412)})