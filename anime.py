...
vk_session = vk_api.VkApi(token = 'e7459baae0b4e3a7b8d92dce2e31cab497368204243caf6b5f7f71a82605f9e7f6188e73ac3427a699bc1') 
#422f0a77cb543213ab9ef515b7c4939adecbdb5904d4ab69e9a8b8846593a7c00165c7b552c50401c7bba - TEST
#e7459baae0b4e3a7b8d92dce2e31cab497368204243caf6b5f7f71a82605f9e7f6188e73ac3427a699bc1 - SadBot
...
for event in longpoll.listen():
	if event.type == VkEventType.MESSAGE_NEW:
		...
		if msg == 'фото':
			if users[user_id].stats == 1:
				users[user_id].photo = random.randint(1, 17)
